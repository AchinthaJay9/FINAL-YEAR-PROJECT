...
const Onboarding1 = () => {
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <Image
        source={require("../assets/onbo3.png")}
        style={styles.upimg}
      />
      <View style={styles.dvbox}>
        <Text style={styles.maintext}>Your Comprehensive Farming Companion </Text>
        <Text style={styles.maintext3}>Gain strong agrotechnical experience tailored to your field</Text>
