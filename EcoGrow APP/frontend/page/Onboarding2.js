...
const Onboarding2 = () => {
  ...
  return (
    ...
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
      <Image
        source={require("../assets/onbo2.png")}
        style={styles.upimg}
      />
      <View style={styles.dvbox}>
        <Text style={styles.maintext}> Navigating Your Agricultural Journey </Text>
        <Text style={styles.maintext3}>Maximize yield and minimize hassles in the age of digital agriculture</Text>
